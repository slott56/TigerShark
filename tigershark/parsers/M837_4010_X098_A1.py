#
# Generated by TigerShark.tools.convertPyX12 on 2012-04-05 18:33:56.307731
#
...
Segment( u'NM1', Properties(syntax=u'P0809 C1110',req_sit=u'R',repeat=u'1',pos=u'020',desc=u'Submitter Name'),
  ...
  Element( u'NM102', Properties(desc=u'Entity Type Qualifier', req_sit=u'R', data_type=(u'ID',u'1',u'1'), position=2,
    codes=[u'1', u'2'] ) ),
  Element( u'NM103', Properties(desc=u'Name Last or Organization Name', req_sit=u'R', data_type=(u'AN',u'1',u'35'), position=3,
    codes=[] ) ),
...
Segment( u'PER', Properties(syntax=u'P0304 P0506 P0708',req_sit=u'R',repeat=u'2',pos=u'045',desc=u'Submitter EDI Contact Information'),
  ...
  Element( u'PER04', Properties(desc=u'Communication Number', req_sit=u'R', data_type=(u'AN',u'1',u'80'), position=4,
    codes=[] ) ),
...
Segment( u'NM1', Properties(syntax=u'P0809 C1110',req_sit=u'R',repeat=u'1',pos=u'020',desc=u'Receiver Name'),
  ...
  Element( u'NM103', Properties(desc=u'Name Last or Organization Name', req_sit=u'R', data_type=(u'AN',u'1',u'35'), position=3,
    codes=[] ) ),
  Element( u'NM104', Properties(desc=u'Name First', req_sit=u'N', data_type=(u'AN',u'1',u'25'), position=4,
    codes=[] ) ),
...
Segment( u'BHT', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'010',desc=u'Beginning of Hierarchical Transaction'),
  ...
  Element( u'BHT02', Properties(desc=u'Transaction Set Purpose Code', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=2,
    codes=[u'00', u'18'] ) ),
  Element( u'BHT03', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'30'), position=3,
    codes=[] ) ),
...
Segment( u'NM1', Properties(syntax=u'P0809 C1110',req_sit=u'R',repeat=u'1',pos=u'250',desc=u'Supervising Provider Name'),
  ...
  Element( u'NM103', Properties(desc=u'Name Last or Organization Name', req_sit=u'R', data_type=(u'AN',u'1',u'35'), position=3,
    codes=[] ) ),
  Element( u'NM104', Properties(desc=u'Name First', req_sit=u'R', data_type=(u'AN',u'1',u'25'), position=4,
    codes=[] ) ),
  Element( u'NM105', Properties(desc=u'Name Middle', req_sit=u'S', data_type=(u'AN',u'1',u'25'), position=5,
    codes=[] ) ),
  Element( u'NM106', Properties(desc=u'Name Prefix', req_sit=u'N', data_type=(u'AN',u'1',u'10'), position=6,
...
Segment( u'NM1', Properties(syntax=u'P0809 C1110',req_sit=u'R',repeat=u'1',pos=u'325',desc=u'Other Payer Patient Information'),
  ...
  Element( u'NM102', Properties(desc=u'Entity Type Qualifier', req_sit=u'R', data_type=(u'ID',u'1',u'1'), position=2,
    codes=[u'1'] ) ),
  Element( u'NM103', Properties(desc=u'Name Last or Organization Name', req_sit=u'N', data_type=(u'AN',u'1',u'35'), position=3,
    codes=[] ) ),
  Element( u'NM104', Properties(desc=u'Name First', req_sit=u'N', data_type=(u'AN',u'1',u'25'), position=4,
    codes=[] ) ),
  Element( u'NM105', Properties(desc=u'Name Middle', req_sit=u'N', data_type=(u'AN',u'1',u'25'), position=5,
...
Segment( u'SBR', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'290',desc=u'Other Subscriber Information'),
  ...
  Element( u'SBR03', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=3,
    codes=[] ) ),
...
Segment( u'MOA', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'320',desc=u'Medicare Outpatient Adjudication Information'),
  Element( u'MOA01', Properties(desc=u'Percent', req_sit=u'S', data_type=(u'R',u'1',u'10'), position=1,
    codes=[] ) ),
  Element( u'MOA02', Properties(desc=u'Monetary Amount', req_sit=u'S', data_type=(u'R',u'1',u'18'), position=2,
    codes=[] ) ),
  Element( u'MOA03', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=3,
    codes=[] ) ),
  Element( u'MOA04', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=4,
    codes=[] ) ),
  Element( u'MOA05', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=5,
    codes=[] ) ),
  Element( u'MOA06', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=6,
    codes=[] ) ),
  Element( u'MOA07', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=7,
    codes=[] ) ),
...
Segment( u'FRM', Properties(syntax=u'R02030405',req_sit=u'R',repeat=u'99',pos=u'552',desc=u'Supporting Documentation'),
  ...
  Element( u'FRM02', Properties(desc=u'Yes/No Condition or Response Code', req_sit=u'S', data_type=(u'ID',u'1',u'1'), position=2,
    codes=[u'N', u'W', u'Y'] ) ),
  Element( u'FRM03', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=3,
    codes=[] ) ),
  Element( u'FRM04', Properties(desc=u'Date', req_sit=u'S', data_type=(u'DT',u'8',u'8'), position=4,
    codes=[] ) ),
  Element( u'FRM05', Properties(desc=u'Percent', req_sit=u'S', data_type=(u'R',u'1',u'6'), position=5,
    codes=[] ) ),
),
)
...
Segment( u'SV1', Properties(syntax=u'P0304',req_sit=u'R',repeat=u'1',pos=u'370',desc=u'Professional Service'),
  ...
  Element( u'SV116', Properties(desc=u'Health Care Professional Shortage Area Code', req_sit=u'N', data_type=(u'ID',u'1',u'1'), position=16,
    codes=[] ) ),
  Element( u'SV117', Properties(desc=u'Reference Identification', req_sit=u'N', data_type=(u'AN',u'1',u'30'), position=17,
    codes=[] ) ),
...
Segment( u'CRC', Properties(syntax='',req_sit=u'S',repeat=u'3',pos=u'450',desc=u'Ambulance Certification'),
  ...
  Element( u'CRC02', Properties(desc=u'Yes/No Condition or Response Code', req_sit=u'R', data_type=(u'ID',u'1',u'1'), position=2,
    codes=[u'N', u'Y'] ) ),
  Element( u'CRC03', Properties(desc=u'Condition Indicator', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=3,
    codes=[u'01', u'02', u'03', u'04', u'05', u'06', u'07', u'08', u'09', u'60'] ) ),
  Element( u'CRC04', Properties(desc=u'Condition Indicator', req_sit=u'S', data_type=(u'ID',u'2',u'2'), position=4,
    codes=[u'01', u'02', u'03', u'04', u'05', u'06', u'07', u'08', u'09', u'60'] ) ),
  Element( u'CRC05', Properties(desc=u'Condition Indicator', req_sit=u'S', data_type=(u'ID',u'2',u'2'), position=5,
    codes=[u'01', u'02', u'03', u'04', u'05', u'06', u'07', u'08', u'09', u'60'] ) ),
  Element( u'CRC06', Properties(desc=u'Condition Indicator', req_sit=u'S', data_type=(u'ID',u'2',u'2'), position=6,
    codes=[u'01', u'02', u'03', u'04', u'05', u'06', u'07', u'08', u'09', u'60'] ) ),
  Element( u'CRC07', Properties(desc=u'Condition Indicator', req_sit=u'S', data_type=(u'ID',u'2',u'2'), position=7,
    codes=[u'01', u'02', u'03', u'04', u'05', u'06', u'07', u'08', u'09', u'60'] ) ),
),
Segment( u'CRC', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'450',desc=u'Hospice Employee Indicator'),
  ...
  Element( u'CRC03', Properties(desc=u'Condition Indicator', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=3,
    codes=[u'65'] ) ),
  Element( u'CRC04', Properties(desc=u'Condition Indicator', req_sit=u'N', data_type=(u'ID',u'2',u'2'), position=4,
    codes=[] ) ),
  Element( u'CRC05', Properties(desc=u'Condition Indicator', req_sit=u'N', data_type=(u'ID',u'2',u'2'), position=5,
    codes=[] ) ),
  Element( u'CRC06', Properties(desc=u'Condition Indicator', req_sit=u'N', data_type=(u'ID',u'2',u'2'), position=6,
    codes=[] ) ),
  Element( u'CRC07', Properties(desc=u'Condition Indicator', req_sit=u'N', data_type=(u'ID',u'2',u'2'), position=7,
    codes=[] ) ),
),
...
Segment( u'CN1', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'465',desc=u'Contract Information'),
  ...
  Element( u'CN102', Properties(desc=u'Monetary Amount', req_sit=u'S', data_type=(u'R',u'1',u'18'), position=2,
    codes=[] ) ),
  Element( u'CN103', Properties(desc=u'Percent', req_sit=u'S', data_type=(u'R',u'1',u'6'), position=3,
    codes=[] ) ),
  Element( u'CN104', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=4,
    codes=[] ) ),
...
Segment( u'PS1', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'488',desc=u'Purchased Service Information'),
  Element( u'PS101', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'30'), position=1,
    codes=[] ) ),
...
Segment( u'HCP', Properties(syntax=u'R0113 P0910 P1112',req_sit=u'S',repeat=u'1',pos=u'492',desc=u'Line Pricing/Repricing Information'),
  ...
  Element( u'HCP03', Properties(desc=u'Monetary Amount', req_sit=u'S', data_type=(u'R',u'1',u'18'), position=3,
    codes=[] ) ),
  Element( u'HCP04', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=4,
    codes=[] ) ),
  Element( u'HCP05', Properties(desc=u'Rate', req_sit=u'S', data_type=(u'R',u'1',u'9'), position=5,
    codes=[] ) ),
  Element( u'HCP06', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=6,
    codes=[] ) ),
...
Segment( u'CLM', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'130',desc=u'Claim Information'),
  Element( u'CLM01', Properties(desc=u'Claim Submitters Identifier', req_sit=u'R', data_type=(u'AN',u'1',u'38'), position=1,
    codes=[] ) ),

#
# Generated by TigerShark.tools.convertPyX12 on 2012-04-05 18:33:55.360773
#
...
Segment( u'SV3', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'380',desc=u'Dental Service'),
  ...
  Element( u'SV305', Properties(desc=u'Prosthesis', req_sit=u'S', data_type=(u'ID',u'1',u'1'), position=5,
    codes=[u'I', u'R'] ) ),
...
Segment( u'QTY', Properties(syntax='',req_sit=u'S',repeat=u'5',pos=u'460',desc=u'Anesthesia Quantity'),
  ...
  Element( u'QTY04', Properties(desc=u'Free-Form Message', req_sit=u'N', data_type=(u'AN',u'1',u'30'), position=4,
    codes=[] ) ),
),
...
Segment( u'DN2', Properties(syntax='',req_sit=u'S',repeat=u'35',pos=u'150',desc=u'Tooth Status'),
  Element( u'DN201', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'30'), position=1,
    codes=[] ) ),

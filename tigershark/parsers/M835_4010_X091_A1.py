#
# Generated by TigerShark.tools.convertPyX12 on 2012-04-05 18:33:53.221907
#
...
Segment( u'CLP', Properties(syntax='',req_sit=u'R',repeat=u'1',pos=u'010',desc=u'Claim Payment Information'),
  Element( u'CLP01', Properties(desc=u'Claim Submitters Identifier', req_sit=u'R', data_type=(u'AN',u'1',u'38'), position=1,
    codes=[] ) ),
  ...
  Element( u'CLP06', Properties(desc=u'Claim Filing Indicator Code', req_sit=u'R', data_type=(u'ID',u'1',u'2'), position=6,
    codes=[u'12', u'13', u'14', u'15', u'16', u'AM', u'CH', u'DS', u'HM', u'LM', u'MA', u'MB', u'MC', u'OF', u'TV', u'VA', u'WC'] ) ),
  Element( u'CLP07', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=7,
    codes=[] ) ),
  ...
  Element( u'CLP12', Properties(desc=u'Quantity', req_sit=u'S', data_type=(u'R',u'1',u'15'), position=12,
    codes=[] ) ),
  Element( u'CLP13', Properties(desc=u'Percent', req_sit=u'S', data_type=(u'R',u'1',u'10'), position=13,
    codes=[] ) ),
),
...
Segment( u'MIA', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'033',desc=u'Inpatient Adjudication Information'),
  ...
  Element( u'MIA04', Properties(desc=u'Monetary Amount', req_sit=u'S', data_type=(u'R',u'1',u'18'), position=4,
    codes=[] ) ),
  Element( u'MIA05', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=5,
    codes=[] ) ),
  ...
  Element( u'MIA19', Properties(desc=u'Monetary Amount', req_sit=u'S', data_type=(u'R',u'1',u'18'), position=19,
    codes=[] ) ),
  Element( u'MIA20', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=20,
    codes=[] ) ),
  Element( u'MIA21', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=21,
    codes=[] ) ),
  Element( u'MIA22', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=22,
    codes=[] ) ),
  Element( u'MIA23', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=23,
    codes=[] ) ),
...
Segment( u'TS3', Properties(syntax='',req_sit=u'S',repeat=u'1',pos=u'005',desc=u'Provider Summary Information'),
  Element( u'TS301', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'30'), position=1,
    codes=[] ) ),
...
Segment( u'PLB', Properties(syntax='',req_sit=u'S',repeat=u'>1',pos=u'010',desc=u'Provider Adjustment'),
  Element( u'PLB01', Properties(desc=u'Reference Identification', req_sit=u'R', data_type=(u'AN',u'1',u'30'), position=1,
    codes=[] ) ),
  ...
  Composite( u'C042', Properties(req_sit=u'R',refdes='',seq=u'03',desc=u'Adjustment Identifier'),
    Element( u'PLB03-01', Properties(desc=u'Adjustment Reason Code', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=0,
      codes=[] ) ),
    Element( u'PLB03-02', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=1,
      codes=[] ) ),
  ),
  ...
  Composite( u'C042', Properties(req_sit=u'S',refdes='',seq=u'05',desc=u'Adjustment Identifier'),
    Element( u'PLB05-01', Properties(desc=u'Adjustment Reason Code', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=0,
      codes=[] ) ),
    Element( u'PLB05-02', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=1,
      codes=[] ) ),
  ),
  ...
  Composite( u'C042', Properties(req_sit=u'S',refdes='',seq=u'07',desc=u'Adjustment Identifier'),
    Element( u'PLB07-01', Properties(desc=u'Adjustment Reason Code', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=0,
      codes=[] ) ),
    Element( u'PLB07-02', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=1,
      codes=[] ) ),
  ),
  ...
  Composite( u'C042', Properties(req_sit=u'S',refdes='',seq=u'09',desc=u'Adjustment Identifier'),
    Element( u'PLB09-01', Properties(desc=u'Adjustment Reason Code', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=0,
      codes=[] ) ),
    Element( u'PLB09-02', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=1,
      codes=[] ) ),
  ),
  ...
  Composite( u'C042', Properties(req_sit=u'S',refdes='',seq=u'11',desc=u'Adjustment Identifier'),
    Element( u'PLB11-01', Properties(desc=u'Adjustment Reason Code', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=0,
      codes=[] ) ),
    Element( u'PLB11-02', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=1,
      codes=[] ) ),
  ),
  ...
  Composite( u'C042', Properties(req_sit=u'S',refdes='',seq=u'13',desc=u'Adjustment Identifier'),
    Element( u'PLB13-01', Properties(desc=u'Adjustment Reason Code', req_sit=u'R', data_type=(u'ID',u'2',u'2'), position=0,
      codes=[] ) ),
    Element( u'PLB13-02', Properties(desc=u'Reference Identification', req_sit=u'S', data_type=(u'AN',u'1',u'30'), position=1,
      codes=[] ) ),
  ),

"""
834.4010.X095.A1
Created 2023-05-12 20:25:34.231622
"""
from .base import *
from . import common
...
class L2320_N1(Segment):
    ...
    class Schema:
        json = {'title': 'Other Insurance Company Name',
         ...
         'properties': {'xid': {'literal': 'N1'},
                        ...
                        'n105': {'$ref': '#/$elements/L2320_N105'},
                        'n106': {'$ref': '#/$elements/L2320_N106'}},
         'required': ['n101']}
        segment_name = 'N1'
    n101: L2320_N101
    ...
    n105: L2320_N105 | None
    n106: L2320_N106 | None

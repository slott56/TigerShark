"""
835.5010.X221.A1
Created 2023-05-12 20:25:34.438165
"""
from .base import *
from . import common
        ...
        json = {'type': 'array',
         'items': {'title': 'Additional Payer Identification',
                   ...
                   'properties': {'xid': {'literal': 'REF'},
                                  ...
                                  'ref04': {'$ref': '#/$elements/L1000A_REF04'}},
                   'required': ['ref01', 'ref02']},
         'maxItems': 4}
        segment_name = 'REF'
    ref01: L1000A_REF01
        ...
        json = {'type': 'array',
         'items': {'title': 'Payee Additional Identification',
                   ...
                   'properties': {'xid': {'literal': 'REF'},
                                  ...
                                  'ref04': {'$ref': '#/$elements/L1000B_REF04'}},
                   'required': ['ref01', 'ref02']}}
        segment_name = 'REF'
    ref01: L1000B_REF01
    ref02: L1000B_REF02
    ...
    class Schema:
        json = {'title': 'Remittance Delivery Method',
         ...
         'properties': {'xid': {'literal': 'RDM'},
                        ...
                        'rdm04': {'$ref': '#/$elements/L1000B_RDM04'},
                        'rdm05': {'$ref': '#/$elements/L1000B_RDM05'}},
         'required': ['rdm01']}
        segment_name = 'RDM'
    rdm01: L1000B_RDM01
    ...
    class Schema:
        json = {'title': 'Claim Payment Information',
         ...
         'properties': {'xid': {'literal': 'CLP'},
                        ...
                        'clp14': {'$ref': '#/$elements/L2100_CLP14'}},
    ...
    class Schema:
        json = {'title': 'Patient Name',
         ...
         'properties': {'xid': {'literal': 'NM1'},
                        ...
                        'nm112': {'$ref': '#/$elements/L2100_NM112'}},
        ...
        json = {'type': 'array',
         'items': {'title': 'Other Claim Related Identification',
                   ...
                   'properties': {'xid': {'literal': 'REF'},
                                  ...
                                  'ref04': {'$ref': '#/$elements/L2100_REF04'}},
                   'required': ['ref01', 'ref02']},
         'maxItems': 5}
        segment_name = 'REF'
    ref01: L2100_REF01
        ...
        json = {'type': 'array',
         'items': {'title': 'Claim Supplemental Information Quantity',
                   ...
                   'properties': {'xid': {'literal': 'QTY'},
                                  ...
                                  'qty03': {'$ref': '#/$elements/L2100_QTY03'},
        ...
        json = {'type': 'array',
         'items': {'title': 'Service Identification',
                   ...
                   'properties': {'xid': {'literal': 'REF'},
                                  ...
                                  'ref04': {'$ref': '#/$elements/L2110_REF04'}},
                   'required': ['ref01', 'ref02']},
         'maxItems': 8}
        segment_name = 'REF'
    ref01: L2110_REF01
        ...
        json = {'type': 'array',
         'items': {'title': 'Service Supplemental Quantity',
                   ...
                   'properties': {'xid': {'literal': 'QTY'},
                                  ...
                                  'qty03': {'$ref': '#/$elements/L2110_QTY03'},

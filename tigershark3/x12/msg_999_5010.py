"""
999.5010
Created 2023-05-19 10:17:36.459043
"""
from .base import *
from .common import *
...
class GS_LOOP_GS(Segment):
    ...
    gs08: Annotated[D_480, Title('Version / Release / Industry Identifier Code'), Usage('R'), Position(8), Enumerated(*['005010X231'])]
...
class ST_LOOP_ST(Segment):
    ...
    st03: Annotated[D_1705, Title('Implementation Convention Reference'), Usage('R'), Position(3), Enumerated(*['005010X231'])]
...
class L2110_C999(Composite):
    ...
    ctx06_02: Annotated[D_725, Title('Data Element Reference Number'), Usage('S'), Position(2)]

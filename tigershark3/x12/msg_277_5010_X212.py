"""
277.5010.X212
Created 2023-05-12 20:25:33.789347
"""
from .base import *
from . import common
...
class L2200B_STC(Segment):
    ...
    stc01: L2200B_STC01
    stc02: L2200B_STC02
    stc03: L2200B_STC03 | None
    stc04: L2200B_STC04 | None
...
class L2200C_STC(Segment):
    ...
    stc01: L2200C_STC01
    stc02: L2200C_STC02
    stc03: L2200C_STC03 | None
    stc04: L2200C_STC04 | None
    ...
    class Schema:
        json = {'title': 'Payer Claim Control Number',
         ...
         'properties': {'xid': {'literal': 'REF'},
                        ...
                        'ref04': {'$ref': '#/$elements/L2200D_REF04'}},
    ...
    class Schema:
        json = {'title': 'Service Line Information',
         ...
         'properties': {'xid': {'literal': 'SVC'},
                        ...
                        'svc06': {'$ref': '#/$elements/L2220D_SVC06'},
    ...
    class Schema:
        json = {'title': 'Service Line Item Identification',
         ...
         'properties': {'xid': {'literal': 'REF'},
                        ...
                        'ref04': {'$ref': '#/$elements/L2220D_REF04'}},
         'required': ['ref01', 'ref02']}
        segment_name = 'REF'
    ref01: L2220D_REF01
    ref02: L2220D_REF02
    ...
    class Schema:
        json = {'title': 'Payer Claim Control Number',
         ...
         'properties': {'xid': {'literal': 'REF'},
                        ...
                        'ref04': {'$ref': '#/$elements/L2200E_REF04'}},
         'required': ['ref01', 'ref02']}
        segment_name = 'REF'
    ref01: L2200E_REF01
    ref02: L2200E_REF02
    ...
    class Schema:
        json = {'title': 'Service Line Information',
         ...
         'properties': {'xid': {'literal': 'SVC'},
                        ...
                        'svc06': {'$ref': '#/$elements/L2220E_SVC06'},
    ...
    class Schema:
        json = {'title': 'Service Line Item Identification',
         ...
         'properties': {'xid': {'literal': 'REF'},
                        ...
                        'ref04': {'$ref': '#/$elements/L2220E_REF04'}},
         'required': ['ref01', 'ref02']}
        segment_name = 'REF'
    ref01: L2220E_REF01
    ref02: L2220E_REF02
...
class TABLE2AREA3(Loop):
    class Schema:
        json = {'title': 'Table2 - Area3',
         ...
         'position': 130,
         'type': 'object',
         'properties': {'footer': {'$ref': '#/$segments/FOOTER'},
                        'se': {'$ref': '#/$segments/TABLE2AREA3_SE'}},
         'required': ['se']}

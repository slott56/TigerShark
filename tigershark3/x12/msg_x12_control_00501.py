"""
x12.control.00501
Created 2023-05-19 10:17:35.814226
"""
from .base import *
from .common import *
...
class GS_LOOP_GS(Segment):
    ...
    gs08: Annotated[D_480, Title('Version / Release / Industry Identifier Code'), Usage('R'), Position(8), Enumerated(*['005010', '005010X214', '005010X218', '005010X279', '005010X220A1', '005010X221A1', '005010X222A1', '005010X223A2'])]

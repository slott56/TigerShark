"""
276.4010.X093.A1
Created 2023-05-12 20:25:33.684016
"""
from .base import *
from . import common
...
class ST_LOOP_ST01(Element):
    ...
    class Schema:
        json = {'title': 'Transaction Set Identifier Code',
         ...
         'position': 1,
         'type': {'allOf': [{'$ref': '#/$common/143'}, {'enum': ['276']}]}}
...
class L2200D_REF01(Element):
    ...
    class Schema:
        json = {'title': 'Reference Identification Qualifier',
         ...
         'description': 'xid=REF01 data_ele=128',
         'position': 1,
         'type': {'allOf': [{'$ref': '#/$common/128'}, {'enum': ['LU']}]}}
        datatype = common.D_128
        codes = ['LU']
        min_len = 2
        max_len = 3
...
class L2200D_REF(Segment):
    ...
    class Schema:
        json = {'title': 'Group Number',
         'usage': 'S',
         'description': 'xid=REF name=Group Number',
         'position': 100,
         'type': 'object',
         'properties': {'xid': {'literal': 'REF'},
                        'ref01': {'$ref': '#/$elements/L2200D_REF01'},
...
class L2200D_AMT01(Element):
    ...
    class Schema:
        json = {'title': 'Amount Qualifier Code',
         ...
         'position': 1,
         'type': {'allOf': [{'$ref': '#/$common/522'}, {'enum': ['T3']}]}}
...
class L2200D_AMT(Segment):
    ...
    class Schema:
        json = {'title': 'Claim Submitted Charges',
         'usage': 'S',
         'description': 'xid=AMT name=Claim Submitted Charges',
         'position': 110,
         'type': 'object',
         'properties': {'xid': {'literal': 'AMT'},
                        'amt01': {'$ref': '#/$elements/L2200D_AMT01'},
                        'amt02': {'$ref': '#/$elements/L2200D_AMT02'},
                        'amt03': {'$ref': '#/$elements/L2200D_AMT03'}},
         'required': ['amt01', 'amt02']}
        segment_name = 'AMT'
    amt01: L2200D_AMT01
    amt02: L2200D_AMT02
    amt03: L2200D_AMT03 | None
...
class L2210D_C003(Composite):
    ...
    svc01_01: L2210D_SVC01_01
    svc01_02: L2210D_SVC01_02
    svc01_03: L2210D_SVC01_03 | None
    svc01_04: L2210D_SVC01_04 | None
    svc01_05: L2210D_SVC01_05 | None
    svc01_06: L2210D_SVC01_06 | None
    svc01_07: L2210D_SVC01_07 | None


class L2210D_SVC02(Element):
    ...
    class Schema:
        json = {'title': 'Service Line Information',
         ...
         'properties': {'xid': {'literal': 'SVC'},
                        'c003': {'$ref': '#/$elements/L2210D_C003'},
                        'svc02': {'$ref': '#/$elements/L2210D_SVC02'},
                        'svc03': {'$ref': '#/$elements/L2210D_SVC03'},
                        'svc04': {'$ref': '#/$elements/L2210D_SVC04'},
                        'svc05': {'$ref': '#/$elements/L2210D_SVC05'},
                        'svc07': {'$ref': '#/$elements/L2210D_SVC07'}},
         'required': ['c003', 'svc02']}
        segment_name = 'SVC'
    c003: L2210D_C003
    svc02: L2210D_SVC02
    svc03: L2210D_SVC03 | None
    svc04: L2210D_SVC04 | None
    svc05: L2210D_SVC05 | None
    svc07: L2210D_SVC07 | None


class L2210D_REF01(Element):
    """Reference Identification Qualifier"""
    class Schema:
        json = {'title': 'Reference Identification Qualifier',
         'usage': 'R',
...
class L2210D_REF(Segment):
    ...
    class Schema:
        json = {'title': 'Service Line Item Identification',
         ...
         'type': 'object',
         'properties': {'xid': {'literal': 'REF'},
                        'ref01': {'$ref': '#/$elements/L2210D_REF01'},
                        'ref02': {'$ref': '#/$elements/L2210D_REF02'},
                        'ref03': {'$ref': '#/$elements/L2210D_REF03'},
                        'c040': {'$ref': '#/$elements/L2210D_C040'}},
         'required': ['ref01', 'ref02']}
        segment_name = 'REF'
    ref01: L2210D_REF01
    ref02: L2210D_REF02
    ref03: L2210D_REF03 | None


class L2210D_DTP01(Element):
    """Date Time Qualifier"""
    class Schema:
        json = {'title': 'Date Time Qualifier',
         'usage': 'R',
...
class L2210D_DTP(Segment):
    ...
    class Schema:
        json = {'title': 'Service Line Date',
         ...
         'type': 'object',
         'properties': {'xid': {'literal': 'DTP'},
                        'dtp01': {'$ref': '#/$elements/L2210D_DTP01'},
                        'dtp02': {'$ref': '#/$elements/L2210D_DTP02'},
                        'dtp03': {'$ref': '#/$elements/L2210D_DTP03'}},
         'required': ['dtp01', 'dtp02', 'dtp03']}
        segment_name = 'DTP'
    dtp01: L2210D_DTP01
    dtp02: L2210D_DTP02
    ...
    class Schema:
        json = {'type': 'array',
         'items': {'title': 'Service Line Information',
                   'usage': 'S',
                   'description': 'xid=2210D name=Service Line Information type=None',
                   'position': 130,
                   'type': 'object',
                   'properties': {'svc': {'$ref': '#/$segments/L2210D_SVC'},
                                  'ref': {'$ref': '#/$segments/L2210D_REF'},
                                  'dtp': {'$ref': '#/$segments/L2210D_DTP'}},
                   'required': ['svc', 'dtp']}}
    svc: L2210D_SVC
    ref: L2210D_REF | None
    dtp: L2210D_DTP
        ...
        json = {'type': 'array',
         'items': {'title': 'Claim Submitter Trace Number',
                   ...
                   'properties': {'trn': {'$ref': '#/$segments/L2200D_TRN'},
                                  ...
                                  'amt': {'$ref': '#/$segments/L2200D_AMT'},
                                  'dtp': {'$ref': '#/$segments/L2200D_DTP'},
                                  'l2210d': {'$ref': '#/$segments/L2210D'}},
                   'required': ['trn']}}
    trn: L2200D_TRN
    ref: L2200D_REF | None
    ref: L2200D_REF | None
...
class L2200E_AMT(Segment):
    ...
    class Schema:
        json = {'title': 'Claim Submitted Charges',
         ...
         'type': 'object',
         'properties': {'xid': {'literal': 'AMT'},
                        'amt01': {'$ref': '#/$elements/L2200E_AMT01'},
                        'amt02': {'$ref': '#/$elements/L2200E_AMT02'},
                        'amt03': {'$ref': '#/$elements/L2200E_AMT03'}},
         'required': ['amt01', 'amt02']}
        segment_name = 'AMT'
    amt01: L2200E_AMT01
    amt02: L2200E_AMT02
    amt03: L2200E_AMT03 | None
        ...
        json = {'title': 'Composite Medical Procedure Identifier',
         ...
         'properties': {'svc01_01': {'title': 'Product or Service ID Qualifier',
                        ...
                        'svc01_07': {'title': 'Description',
                                     ...
                                     'type': {'$ref': '#/$common/352'}}},
         'required': ['svc01_01', 'svc01_02']}
    svc01_01: L2210E_SVC01_01
    svc01_02: L2210E_SVC01_02
    svc01_03: L2210E_SVC01_03 | None
    svc01_04: L2210E_SVC01_04 | None
    svc01_05: L2210E_SVC01_05 | None
    svc01_06: L2210E_SVC01_06 | None
    svc01_07: L2210E_SVC01_07 | None


class L2210E_SVC02(Element):
    """Line Item Charge Amount"""
    class Schema:
        json = {'title': 'Line Item Charge Amount',
         'usage': 'R',
...
class L2210E_SVC(Segment):
    ...
    class Schema:
        json = {'title': 'Service Line Information',
         ...
         'type': 'object',
         'properties': {'xid': {'literal': 'SVC'},
                        'c003': {'$ref': '#/$elements/L2210E_C003'},
                        'svc02': {'$ref': '#/$elements/L2210E_SVC02'},
                        'svc03': {'$ref': '#/$elements/L2210E_SVC03'},
                        'svc04': {'$ref': '#/$elements/L2210E_SVC04'},
                        'svc05': {'$ref': '#/$elements/L2210E_SVC05'},
                        'svc07': {'$ref': '#/$elements/L2210E_SVC07'}},
         'required': ['c003', 'svc02']}
        segment_name = 'SVC'
    c003: L2210E_C003
    svc02: L2210E_SVC02
    svc03: L2210E_SVC03 | None
    svc04: L2210E_SVC04 | None
    svc05: L2210E_SVC05 | None
    svc07: L2210E_SVC07 | None


class L2210E_REF01(Element):
    """Reference Identification Qualifier"""
    class Schema:
        json = {'title': 'Reference Identification Qualifier',
         'usage': 'R',
...
class L2210E_REF(Segment):
    ...
    class Schema:
        json = {'title': 'Service Line Item Identification',
         ...
         'type': 'object',
         'properties': {'xid': {'literal': 'REF'},
                        'ref01': {'$ref': '#/$elements/L2210E_REF01'},
                        'ref02': {'$ref': '#/$elements/L2210E_REF02'},
                        'ref03': {'$ref': '#/$elements/L2210E_REF03'},
                        'c040': {'$ref': '#/$elements/L2210E_C040'}},
         'required': ['ref01', 'ref02']}
        segment_name = 'REF'
    ref01: L2210E_REF01
    ref02: L2210E_REF02
    ref03: L2210E_REF03 | None


class L2210E_DTP01(Element):
    """Date Time Qualifier"""
    class Schema:
        json = {'title': 'Date Time Qualifier',
         'usage': 'R',
...
class L2210E_DTP(Segment):
    ...
    class Schema:
        json = {'title': 'Service Line Date',
         ...
         'type': 'object',
         'properties': {'xid': {'literal': 'DTP'},
                        'dtp01': {'$ref': '#/$elements/L2210E_DTP01'},
                        'dtp02': {'$ref': '#/$elements/L2210E_DTP02'},
                        'dtp03': {'$ref': '#/$elements/L2210E_DTP03'}},
         'required': ['dtp01', 'dtp02', 'dtp03']}
        segment_name = 'DTP'
    dtp01: L2210E_DTP01
    dtp02: L2210E_DTP02
...
class L2210E(Loop):
    class Schema:
        json = {'type': 'array',
         'items': {'title': 'Service Line Information',
                   'usage': 'S',
                   'description': 'xid=2210E name=Service Line Information type=None',
                   'position': 130,
                   'type': 'object',
                   'properties': {'svc': {'$ref': '#/$segments/L2210E_SVC'},
                                  'ref': {'$ref': '#/$segments/L2210E_REF'},
                                  'dtp': {'$ref': '#/$segments/L2210E_DTP'}},
                   'required': ['svc']}}
    svc: L2210E_SVC
    ref: L2210E_REF | None
    dtp: L2210E_DTP | None
        ...
        json = {'type': 'array',
         'items': {'title': 'Claim Submitter Trace Number',
                   ...
                   'properties': {'trn': {'$ref': '#/$segments/L2200E_TRN'},
                                  ...
                                  'amt': {'$ref': '#/$segments/L2200E_AMT'},
                                  'dtp': {'$ref': '#/$segments/L2200E_DTP'},
                                  'l2210e': {'$ref': '#/$segments/L2210E'}},
                   'required': ['trn']}}
    trn: L2200E_TRN
    ref: L2200E_REF | None
    ref: L2200E_REF | None
...
class MSG276(Message):
    ...
    class Schema:
        json = {'title': 'HIPAA Health Care Claim Status Request X093A1-276',
         'description': 'xid=276 name=HIPAA Health Care Claim Status Request '
                        'X093A1-276',
         'type': 'object',

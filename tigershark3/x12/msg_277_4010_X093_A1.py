"""
277.4010.X093.A1
Created 2023-05-19 10:17:35.847632
"""
from .base import *
from .common import *
...
class L2100B_NM1(Segment):
    ...
    nm106: Annotated[D_1038, Title('Information Receiver Name Prefix'), Usage('S'), Position(6)]
...
class L2200D_C043(Composite):
    ...
    stc01_03: Annotated[D_98, Title('Entity Identifier Code'), Usage('S'), Position(3), Enumerated(*entity_id)]
...
class L2200D_STC(Segment):
    ...
    stc05: Annotated[D_782, Title('Claim Payment Amount'), Usage('R'), Position(5)]
    
    stc06: Annotated[D_373, Title('Adjudication or Payment Date'), Usage('S'), Position(6)]
    
    stc07: Annotated[D_591, Title('Payment Method Code'), Usage('S'), Position(7), Enumerated(*['ACH', 'BOP', 'CHK', 'FWT', 'NON'])]
    
    stc08: Annotated[D_373, Title('Check Issue or EFT Effective Date'), Usage('S'), Position(8)]
    
    stc09: Annotated[D_429, Title('Check or EFT Trace Number'), Usage('S'), Position(9)]
...
class L2200D_DTP(Segment):
    ...
    dtp03: Annotated[D_1251, Title('Claim Service Date'), Usage('R'), Position(3)]
...
class L2220D_STC(Segment):
    ...
    stc04: Annotated[D_782, Title('Line Item Charge Amount'), Usage('S'), Position(4)]
    
    stc05: Annotated[D_782, Title('Line Item Provider Payment Amount'), Usage('S'), Position(5)]
...
class L2220D(Loop):
    ...
    svc: Annotated[L2220D_SVC, Title('Service Line Information'), Usage('R'), Position(180), Required(True)]
    
    stc: Annotated[L2220D_STC, Title('Service Line Status Information'), Usage('S'), Position(190), Required(True)]
    
    ref: Annotated[L2220D_REF, Title('Service Line Item Identification'), Usage('S'), Position(200), Required(True)]
    
    dtp: Annotated[L2220D_DTP, Title('Service Line Date'), Usage('S'), Position(210), Required(True)]
...
class L2200D(Loop):
    ...
    stc: Annotated[L2200D_STC, Title('Claim Level Status Information'), Usage('R'), Position(100), Required(True)]
    
    ref: Annotated[L2200D_REF, Title('Payer Claim Identification Number'), Usage('S'), Position(110), Required(True)]
    
    ref: Annotated[L2200D_REF, Title('Institutional Bill Type Identification'), Usage('S'), Position(110), Required(True)]
    
    ref: Annotated[L2200D_REF, Title('Medical Record Identification'), Usage('S'), Position(110), Required(True)]
    
    dtp: Annotated[L2200D_DTP, Title('Claim Service Date'), Usage('S'), Position(120), Required(True)]
    ItemL2220D: TypeAlias = Annotated[L2220D, Title('Service Line Information'), Usage('S'), Position(180), Required(True)]
...
class L2200E_STC(Segment):
    ...
    c043: Annotated[L2200E_C043, Title('Health Care Claim Status'), Usage('R'), Position(1), Required(True)]
    ...
    c043: Annotated[L2200E_C043, Title('Health Care Claim Status'), Usage('S'), Position(10), Required(True)]
    
    c043: Annotated[L2200E_C043, Title('Health Care Claim Status'), Usage('S'), Position(11), Required(True)]
...
class L2220E_SVC(Segment):
    ...
    c003: Annotated[L2220E_C003, Title('Composite Medical Procedure Identifier'), Usage('R'), Position(1), Required(True)]
...
class L2220E_STC(Segment):
    ...
    c043: Annotated[L2220E_C043, Title('Health Care Claim Status'), Usage('R'), Position(1), Required(True)]
    ...
    c043: Annotated[L2220E_C043, Title('Health Care Claim Status'), Usage('S'), Position(10), Required(True)]
    
    c043: Annotated[L2220E_C043, Title('Health Care Claim Status'), Usage('S'), Position(11), Required(True)]
...
class L2220E(Loop):
    ...
    svc: Annotated[L2220E_SVC, Title('Service Line Information'), Usage('R'), Position(180), Required(True)]
    
    stc: Annotated[L2220E_STC, Title('Service Line Status Information'), Usage('S'), Position(190), Required(True)]
    
    ref: Annotated[L2220E_REF, Title('Service Line Item Identification'), Usage('S'), Position(200), Required(True)]
    
    dtp: Annotated[L2220E_DTP, Title('Service Line Date'), Usage('S'), Position(210), Required(True)]
...
class L2200E(Loop):
    ...
    stc: Annotated[L2200E_STC, Title('Claim Level Status Information'), Usage('R'), Position(100), Required(True)]
    
    ref: Annotated[L2200E_REF, Title('Payer Claim Identification Number'), Usage('R'), Position(110), Required(True)]
    
    ref: Annotated[L2200E_REF, Title('Institutional Bill Type Identification'), Usage('S'), Position(110), Required(True)]
    
    ref: Annotated[L2200E_REF, Title('Medical Record Identification'), Usage('S'), Position(110), Required(True)]
    
    dtp: Annotated[L2200E_DTP, Title('Claim Service Date'), Usage('S'), Position(120), Required(True)]
    ItemL2220E: TypeAlias = Annotated[L2220E, Title('Service Line Information'), Usage('S'), Position(180), Required(True)]

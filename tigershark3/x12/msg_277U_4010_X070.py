"""
277U.4010.X070
Created 2023-05-12 20:25:33.898688
"""
from .base import *
from . import common
...
class GS_LOOP_GS08(Element):
    ...
    class Schema:
        json = {'title': 'Version / Release / Industry Identifier Code',
         ...
         'position': 8,
         'type': {'allOf': [{'$ref': '#/$common/480'}, {'enum': ['004010X070']}]}}
...
class HEADER_BHT06(Element):
    ...
    class Schema:
        json = {'title': 'Transaction Type Code',
         ...
         'position': 6,
         'type': {'allOf': [{'$ref': '#/$common/640'}, {'enum': ['NO']}]}}
...
class MSG277(Message):
    ...
    class Schema:
        json = {'title': 'HIPAA Health Care Claim Unsolicited Status Response X070-277U',
         'description': 'xid=277 name=HIPAA Health Care Claim Unsolicited Status '
                        'Response X070-277U',
         'type': 'object',

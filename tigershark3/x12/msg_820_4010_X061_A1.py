"""
820.4010.X061.A1
Created 2023-05-19 10:17:35.929139
"""
from .base import *
from .common import *
...
class GS_LOOP_GS(Segment):
    ...
    gs08: Annotated[D_480, Title('Version / Release / Industry Identifier Code'), Usage('R'), Position(8), Enumerated(*['004010X061A1'])]
...
class HEADER_BPR(Segment):
    ...
    bpr04: Annotated[D_591, Title('Payment Method Code'), Usage('R'), Position(4), Enumerated(*['ACH', 'BOP', 'CHK', 'FWT', 'SWT'])]
    ...
    bpr08: Annotated[D_569, Title('Account Number Qualifier'), Usage('S'), Position(8), Enumerated(*['DA', 'ALC'])]
    
    bpr09: Annotated[D_508, Title('Sender Bank Account Number'), Usage('S'), Position(9)]
    
    bpr10: Annotated[D_509, Title('Originating Company Identifier'), Usage('S'), Position(10)]
...
class HEADER_CUR(Segment):
    ...
    cur02: Annotated[D_100, Title('Currency Code'), Usage('R'), Position(2), Enumerated(*['MXP', 'CAD', 'USD'])]
...
class HEADER_REF(Segment):
    ...
    ref01: Annotated[D_128, Title('Reference Identification Qualifier'), Usage('R'), Position(1), Enumerated(*['14', '18', '2F', '38', '72'])]
...
class L1000A_N1(Segment):
    ...
    n102: Annotated[D_93, Title('Information Receiver Last or Organization Name'), Usage('S'), Position(2)]
    
    n103: Annotated[D_66, Title('Identification Code Qualifier'), Usage('S'), Position(3), Enumerated(*['1', '9', 'EQ', 'FI', 'XV'])]
    
    n104: Annotated[D_67, Title('Receiver Identifier'), Usage('S'), Position(4)]
...
class L1000A_N2(Segment):
    ...
    n201: Annotated[D_93, Title('Receiver Additional Name'), Usage('R'), Position(1)]
...
class L1000A_N3(Segment):
    ...
    n301: Annotated[D_166, Title('Receiver Address Line'), Usage('R'), Position(1)]
    
    n302: Annotated[D_166, Title('Receiver Address Line'), Usage('S'), Position(2)]
...
class L1000A(Loop):
    ...
    n1: Annotated[L1000A_N1, Title("Premium Receiver's Name"), Usage('R'), Position(70), Required(True)]
    
    n2: Annotated[L1000A_N2, Title('Premium Receiver Additional Name'), Usage('S'), Position(80), Required(True)]
    
    n3: Annotated[L1000A_N3, Title("Premium Receiver's Address"), Usage('S'), Position(90), Required(True)]
    
    n4: Annotated[L1000A_N4, Title("Premium Receiver's City, State, ZIP"), Usage('S'), Position(100), Required(True)]
...
class L1000B_N1(Segment):
    ...
    n103: Annotated[D_66, Title('Identification Code Qualifier'), Usage('S'), Position(3), Enumerated(*['1', '9', '24', '65', '75', 'EQ', 'FI', 'PI'])]
...
class L1000B_N4(Segment):
    ...
    n402: Annotated[D_156, Title('Premium Payer State Code'), Usage('R'), Position(2), Enumerated(*states)]
    
    n403: Annotated[D_116, Title('Premium Payer Postal Zone or ZIP Code'), Usage('R'), Position(3)]
...
class L1000B_PER(Segment):
    ...
    per04: Annotated[D_364, Title('Communication Number'), Usage('S'), Position(4)]
...
class L1000B(Loop):
    ...
    n1: Annotated[L1000B_N1, Title("Premium Payer's Name"), Usage('R'), Position(70), Required(True)]
    
    n2: Annotated[L1000B_N2, Title('Premium Payer Additional Name'), Usage('S'), Position(80), Required(True)]
    
    n3: Annotated[L1000B_N3, Title("Premium Payer's Address"), Usage('S'), Position(90), Required(True)]
    
    n4: Annotated[L1000B_N4, Title("Premium Payer's City, State, ZIP"), Usage('S'), Position(100), Required(True)]
    ItemPer: TypeAlias = Annotated[L1000B_PER, Title("Premium Payer's Administrative Contact"), Usage('S'), Position(120), Required(True)]
...
class HEADER(Loop):
    ...
    trn: Annotated[HEADER_TRN, Title('Reassociation Key'), Usage('R'), Position(35), Required(True)]
    
    cur: Annotated[HEADER_CUR, Title('Non-US Dollars Currency'), Usage('S'), Position(40), Required(True)]
    ItemRef: TypeAlias = Annotated[HEADER_REF, Title('Premium Receivers Identification Key'), Usage('S'), Position(50), Required(True)]
    ref: Annotated[list[ItemRef], MinItems(1)]
    
    dtm: Annotated[HEADER_DTM, Title('Process Date'), Usage('S'), Position(60), Required(True)]
    
    dtm: Annotated[HEADER_DTM, Title('Delivery Date'), Usage('S'), Position(60), Required(True)]
    
    dtm: Annotated[HEADER_DTM, Title('Coverage Period'), Usage('S'), Position(60), Required(True)]
    ItemL1000A: TypeAlias = Annotated[L1000A, Title("Premium Receiver's Name"), Usage('R'), Position(70), Required(True)]
    l1000a: Annotated[list[ItemL1000A], MinItems(1)]
    ItemL1000B: TypeAlias = Annotated[L1000B, Title("Premium Payer's Name"), Usage('R'), Position(70), Required(True)]
...
class L2000A_ENT(Segment):
    ...
    ent02: Annotated[D_98, Title('Entity Identifier Code'), Usage('R'), Position(2), Enumerated(*['2L'])]
    
    ent03: Annotated[D_66, Title('Identification Code Qualifier'), Usage('S'), Position(3), Enumerated(*['1', '9', 'FI'])]
    
    ent04: Annotated[D_67, Title('Organization Identification Code'), Usage('S'), Position(4)]
...
class L2315A_SLN(Segment):
    ...
    c001: Annotated[L2315A_C001, Title('Composite Unit of Measure'), Usage('R'), Position(5), Required(True)]
...
class L2315A(Loop):
    ...
    sln: Annotated[L2315A_SLN, Title('Member Count'), Usage('R'), Position(204), Required(True)]


class L2310A(Loop):
    
    it1: Annotated[L2310A_IT1, Title('Summary Line Item'), Usage('R'), Position(190), Required(True)]
    ItemL2315A: TypeAlias = Annotated[L2315A, Title('Member Count'), Usage('S'), Position(204), Required(True)]
    l2315a: Annotated[list[ItemL2315A], MinItems(1)]
...
class L2320A_ADX(Segment):
    ...
    adx02: Annotated[D_426, Title('Adjustment Reason Code'), Usage('R'), Position(2), Enumerated(*['20', '52', '53', 'AA', 'H1', 'H6', 'IA', 'J3'])]
...
class L2320A(Loop):
    ...
    adx: Annotated[L2320A_ADX, Title('Organization Summary Remittance Level Adjustment'), Usage('R'), Position(210), Required(True)]


class L2300A(Loop):
    
    rmr: Annotated[L2300A_RMR, Title('Organization Summary Remittance Detail'), Usage('R'), Position(150), Required(True)]
    ItemL2310A: TypeAlias = Annotated[L2310A, Title('Summary Line Item'), Usage('S'), Position(190), Required(True)]
    l2310a: Annotated[list[ItemL2310A], MinItems(1)]
    ItemL2320A: TypeAlias = Annotated[L2320A, Title('Organization Summary Remittance Level Adjustment'), Usage('S'), Position(210), Required(True)]
    l2320a: Annotated[list[ItemL2320A], MinItems(1)]


class L2000A(Loop):
    
    ent: Annotated[L2000A_ENT, Title('Organization Summary Remittance'), Usage('R'), Position(10), Required(True)]
    ItemL2300A: TypeAlias = Annotated[L2300A, Title('Organization Summary Remittance Detail'), Usage('R'), Position(150), Required(True)]
...
class L2000B_ENT(Segment):
    ...
    ent03: Annotated[D_66, Title('Identification Code Qualifier'), Usage('R'), Position(3), Enumerated(*['34', 'EI', 'ZZ'])]
...
class L2100B_NM1(Segment):
    ...
    nm101: Annotated[D_98, Title('Entity Identifier Code'), Usage('R'), Position(1), Enumerated(*['EY', 'QE'])]
...
class L2100B(Loop):
    ...
    nm1: Annotated[L2100B_NM1, Title('Individual Name'), Usage('R'), Position(20), Required(True)]
...
class L2300B_RMR(Segment):
    ...
    rmr03: Annotated[D_482, Title('Payment Action Code'), Usage('S'), Position(3), Enumerated(*['PI', 'PP'])]
...
class L2320B(Loop):
    ...
    adx: Annotated[L2320B_ADX, Title('Individual Premium Adjustment'), Usage('R'), Position(210), Required(True)]


class L2300B(Loop):
    
    rmr: Annotated[L2300B_RMR, Title('Individual Premium Remittance Detail'), Usage('R'), Position(150), Required(True)]
    
    dtm: Annotated[L2300B_DTM, Title('Individual Coverage Period'), Usage('S'), Position(180), Required(True)]
    ItemL2320B: TypeAlias = Annotated[L2320B, Title('Individual Premium Adjustment'), Usage('S'), Position(210), Required(True)]
    l2320b: Annotated[list[ItemL2320B], MinItems(1)]


class L2000B(Loop):
    
    ent: Annotated[L2000B_ENT, Title('Individual Remittance'), Usage('R'), Position(10), Required(True)]
    ItemL2100B: TypeAlias = Annotated[L2100B, Title('Individual Name'), Usage('S'), Position(20), Required(True)]
    l2100b: Annotated[list[ItemL2100B], MinItems(1)]
    ItemL2300B: TypeAlias = Annotated[L2300B, Title('Individual Premium Remittance Detail'), Usage('S'), Position(150), Required(True)]
    l2300b: Annotated[list[ItemL2300B], MinItems(1)]


class DETAIL(Loop):
    ItemL2000A: TypeAlias = Annotated[L2000A, Title('Organization Summary Remittance'), Usage('S'), Position(10), Required(True)]
    l2000a: Annotated[list[ItemL2000A], MinItems(1)]
    ItemL2000B: TypeAlias = Annotated[L2000B, Title('Individual Remittance'), Usage('S'), Position(160), Required(True)]
...
class ST_LOOP(Loop):
    ...
    st: Annotated[ST_LOOP_ST, Title('820 Header'), Usage('R'), Position(10), Required(True)]
    ...
    se: Annotated[ST_LOOP_SE, Title('820 Trailer'), Usage('R'), Position(50), Required(True)]

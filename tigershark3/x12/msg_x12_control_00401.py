"""
x12.control.00401
Created 2023-03-25 09:22:27.862299
"""
from .base import *
from . import common
...
class ISA_LOOP_ISA12(Element):
    ...
    class Schema:
        json = {'title': 'Interchange Control Version Number',
         ...
         'sequence': 12,
         'type': {'allOf': [{'$ref': '#/$common/I11'},
                            {'enum': ['00400', '00401', '00402']}]}}
        datatype = common.I11
        codes = ['00400', '00401', '00402']
        min_len = 5
        max_len = 5
    ...
    class Schema:
        json = {'title': 'Version / Release / Industry Identifier Code',
         ...
         'type': {'allOf': [{'$ref': '#/$common/480'},
                            {'enum': ['004010', '004010X070', '004010X093',
                                      '004010X092', '004010X094', '004010X061',
                                      '004010X095', '004010X091', '004010X096',
                                      '004010X097', '004010X098', '004010X093A1',
                                      '004010X092A1', '004010X094A1', '004010X061A1',
                                      '004010X095A1', '004010X091A1', '004010X096A1',
                                      '004010X097A1', '004010X098A1']}]}}
        datatype = common.D_480
        codes = ['004010', '004010X070', '004010X093', '004010X092', '004010X094', '004010X061', '004010X095', '004010X091', '004010X096', '004010X097', '004010X098', '004010X093A1', '004010X092A1', '004010X094A1', '004010X061A1', '004010X095A1', '004010X091A1', '004010X096A1', '004010X097A1', '004010X098A1']
        min_len = 1
        max_len = 12
